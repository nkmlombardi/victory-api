...
module.exports = function(app) {
    ...
    // OneLink Software
        ...
        // app.route('/v1/origins/{id}/')                       .get(controllers.origin.getOrigin);
            ...
            // app.route('/v1/origins/{id}/servers')            .get(controllers.origin.getOriginServers);
        ...
        // app.route('/v1/targets/{id}/')                       .get(controllers.target.getTarget);
            ...
            // app.route('/v1/targets/{id}/origin')             .get(controllers.target.getTargetOrigins);

            //// One to Many Relationships
            // app.route('/v1/targets/{id}/clusters')           .get(controllers.target.getTargetClusters);
            // app.route('/v1/targets/{id}/servers')            .get(controllers.target.getTargetServers);
    ...
    // OneLink Infrastructure
        ...
        // app.route('/v1/datacenters/{id}/')                   .get(controllers.datacenter.getDatacenter);
            ...
            // app.route('/v1/datacenters/{id}/servers')        .get(controllers.datacenter.getDatacenterServers);
        ...
        // app.route('/v1/clusters/{id}/')                      .get(controllers.cluster.getCluster);
            ...
            // app.route('/v1/clusters/{id}/servers')           .get(controllers.cluster.getClusterServers);


        // Server Resource
        // app.route('/v1/servers')                             .get(controllers.server.getServers);
        // app.route('/v1/servers/{id}/')                       .get(controllers.server.getServer);

            //// One to One Relationships
            // app.route('/v1/servers/{id}/datacenter')         .get(controllers.server.getServerDatacenter);
            // app.route('/v1/servers/{id}/cluster')            .get(controllers.server.getServerCluster);

            //// One to Many Relationships
            // app.route('/v1/servers/{id}/clients')            .get(controllers.server.getServerClients);
            // app.route('/v1/servers/{id}/projects')           .get(controllers.server.getServerProjects);
            // app.route('/v1/servers/{id}/origins')            .get(controllers.server.getServerOrigins);
            // app.route('/v1/servers/{id}/targets')            .get(controllers.server.getServerTargets);
